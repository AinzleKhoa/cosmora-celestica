...
<body class="bg-[#1B222E] font-sans text-gray-800">
    ...
    <div class="max-w-5xl mx-auto p-6   rounded shadow mt-6">
        <!-- Header Top Bar -->
        <div class="flex justify-between border-b border-gray-200 pb-3 text-sm text-white">
            <button aria-label="Trở lại" class="flex items-center space-x-1 hover:text-orange-600 font-medium">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 stroke-current" fill="none" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" /></svg>
                <span>Back</span>
            </button>
            <div>
                <% if (currentStep >= 4) {
