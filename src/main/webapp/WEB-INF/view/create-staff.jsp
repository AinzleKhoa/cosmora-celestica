    ...
    <body>
        ...
        <main class="admin-main">
            ...
            <div class="admin-manage-wrapper container py-4">
                <div class="mb-4">
                    <a href="${pageContext.servletContext.contextPath}/staffmanagement?view=list" class="admin-manage-back mb-5">
                ...
                <form action="${pageContext.servletContext.contextPath}/staffmanagement" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <a href="${pageContext.servletContext.contextPath}/staffmanagement?view=list" class="admin-manage-back">
                            <i class="fas fa-arrow-left mr-1"></i> Back
                        </a>
