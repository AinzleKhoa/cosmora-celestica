...
<<<<<<< Updated upstream:src/main/webapp/WEB-INF/admin/product-list.jsp
...
>>>>>>> Stashed changes:src/main/webapp/WEB-INF/dashboard/product-list.jsp
            </div>
        </div>              
    </section>
            ...
            <table class="table table-dark table-bordered table-hover align-middle mb-0">
                ...
                <tbody>
                    <%
                        ...
                        int rowNumber = 1; // Số thứ tự tự tăng
                    ...
                    <tr>
                        ...
                        <td>
                            <%-- Giá Sale lấy trực tiếp từ đối tượng Product --%>
                    ...
                    %>
                    <tr>
                        <%-- Cập nhật colspan từ 8 thành 7 vì đã bỏ 1 cột --%>
