        ...
        <main class="container-fluid p-4 p-lg-5">
            ...
            <div class="page-header">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<%= request.getContextPath()%>/products?action=update&id=<%= product.getProductId()%>" class="btn btn-warning"><i class="fas fa-edit me-1"></i> Edit</a>
                    <a href="<%= request.getContextPath()%>/products?action=delete&id=<%= product.getProductId()%>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this product?');"><i class="fas fa-trash me-1"></i> Delete</a>
                </div>
            </div>
