...
<body>
                        ...
                        <div class="header__content">
                            ...
                            <div class="admin-dropdown" onclick="toggleDropdown()">
                                <div class="admin-profile">
                                    <img src="<%= contextPath %>/assets/img/user.svg" alt="Avatar" class="admin-avatar">
                                    <div>
        ...
        <section class="admin-header">
            <div class="admin-header-top">
                ...
                <div class="search-filter-wrapper">
                    <input type="text" class="search-input" placeholder="Enter product name...">
                    <button class="search-btn">Search</button>
                </div>
            </div>
            <div class="main-filter">
                <span><i class="fas fa-box fas-filter-icon"></i>Main Category:</span>
                <div class="filter-btns">
                    <button class="filter-btn active">All</button>
                    <button class="filter-btn">Game</button>
                    <button class="filter-btn">Headset</button>
                    <button class="filter-btn">Keyboard</button>
                    <button class="filter-btn">Mouse</button>
                    <button class="filter-btn">Controller</button>
                </div>
            </div>
            <div class="main-filter">
    ...
    <script>
        // Thêm hàm toggleDropdown nếu nó nằm trong file main.js
